...
sap.ui.define([
    ...
    return UIComponent.extend("sap.ushell.components.tiles.cdm.applauncherdynamic.Component", {
        ...
        createContent: function () {
            ...
            // UIComponent.createContent requires the view object to be built sync
            // therefore we need the legacy view factory
            ...
            this.oPromise = oTile.loaded().then(function (oView) {
